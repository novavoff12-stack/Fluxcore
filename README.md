...
<div>
  <div align="left">
    ...
    <h1>Fluxcore (Fork of Firefli)</h1>
  </div>
    <img src="https://img.shields.io/badge/version-v1.1.4-purple"></img>
  <ul>
  ...
  <ul>
    <li>
      ðŸ“„ Don't know how to install? â€“â€“ <a href="https://docs.firefli.net">Visit our documentation!</a>
    </li>
    <li>
      ðŸ› Bugs? Have ideas? â€“â€“ <a href="https://feedback.firefli.net/bugs">Get support and let us know here!</a>
    </li>
    <li>
      âœ¨ Updates â€“â€“ <a href="https://feedback.firefli.net/changelog">View our Features and updates!</a>
    </li>
  </ul>

  <p><strong>Required environment variables:</strong></p>
  <ul>
    <li><code>SESSION_SECRET</code> â€“ A strong secret string (e.g. generated via <code>openssl rand -base64 32</code>)</li>
    <li><code>DATABASE_URL</code> â€“ Your connection string (e.g. hosted on Supabase, Railway, Neon, etc.)</li>
    <li><code>NEXTAUTH_URL</code> â€“ Your Domain/Connection URL (e.g. https://domain.domain.com - no / at end.)</li>
  ...
  <ul>
    <li><code>ROBLOX_CLIENT_ID</code> â€“ Roblox oAuth ID (e.g. 1312974419555602493</code>)</li>
    <li><code>ROBLOX_CLIENT_SECRET</code> â€“ Your client secret (e.g. RBX-GLEmbz3yrU...)</li>
    <li><code>ROBLOX_REDIRECT_URI</code> â€“ Your Domain Callback URI (e.g. https://domain.domain.com/api/auth/roblox/callback .)</li>
    <li><code>ROBLOX_OAUTH_ONLY</code> â€“ Force oAuth as only login method (e.g. true/false)</li>
    <li><code>NEXT_MULTI</code> â€“ Having trouble being rate limited syncing your group? Set this to true to optimise your group sync (e.g. true .)</li>
  </ul>
